...
from x_vc.models.codec.sac.modules.vocoder.stft_utils import IMDCT, ISTFT
...
class VocosDecoder(nn.Module):
    def __init__(
        ...
        self.backbone = VocosBackbone(
            ...
            condition_dim=adanorm_num_embeddings,
        )
        self.head = ISTFTHead(vocos_dim, n_fft, hop_size, padding)
