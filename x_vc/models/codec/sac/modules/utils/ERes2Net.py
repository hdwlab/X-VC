...
import x_vc.models.codec.sac.modules.utils.pooling_layers as pooling_layers
from x_vc.models.codec.sac.modules.utils.fusion import AFF
...
class ERes2Net(nn.Module):
    ...
    def forward(self, x):
        ...
        if self.two_emb_layer:
            ...
            return embed_b, fuse_out1234
        else:
            return embed_a, fuse_out1234
